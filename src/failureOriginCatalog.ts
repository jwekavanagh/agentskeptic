...
export const REASON_CODE_TO_ORIGIN: Record<string, FailureOrigin> = {
  ...
  [SQL_VERIFICATION_OUTCOME_CODE.BOUNDED_WINDOW_EXPIRED_WITHOUT_OBSERVATION]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.BOUNDED_MODE_UNSUPPORTED_FOR_CONNECTOR]: INPUTS,
  [SQL_VERIFICATION_OUTCOME_CODE.CONNECTOR_UNSUPPORTED_IN_SCOPE]: WORKFLOW_FLOW,
